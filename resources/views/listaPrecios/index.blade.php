...
@section('content')
    ...
    <div class="row no-gutters">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" id="btn-cancelar-cerrarSesion-listPrecios"
                                class="btn btn-primary-logout col-md-6" data-dismiss="modal">CANCELAR</button>

                            <button type="button" id="btn-aceptar-cerrarSesion-listPrecios"
        ...
        <div class="col-6 col-md-6 col-lg-2">
            <p>
                <a href="{{ route('listaprecios.create') }}" class="btn btn-primary" id="addProducto"> <img
                        src="./imagenes/imagenes/icon_add.png" alt="Botón Buscar" height="15" width="15"> AÑADIR PRODUCTO
                </a>
            </p>
        </div>
    </div>
        ...
        <div class="col-12 col-lg-4 ">
            ...
            <div class="row ">
                ...
                <div class="col-3 col-lg-3">
                    <button class="btn btn-buscar" type="submit"><img id="img_lupa" src="./imagenes/imagenes/icon_lupa.png"
                            alt="Botón Buscar" height="25" width="25"></button>
                </div>
                ...
                @foreach ($establecimientoProductos as $establecimientoProducto)
                    @foreach ($establecimientoProducto->productos as $establec)
                        <tr class="fila-tabla">
                            ...
                            <td>
                                <a href="#ventana2" class="btn btn-link" data-toggle="modal"><img
                                        src="./imagenes/imagenes/icon_edit.svg" alt="Editar" height="25" width="25"></a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary-logout col-md-6">
                                                    <div id="navbarDropdown" class="btn-primary-logout" href="#"
                                ...
                                <form action="{{ route('listaprecios.destroy', $establecimientoProducto) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-link"><img
                                            src="./imagenes/imagenes/icon_delete.svg" alt="Editar" height="20"
                                            width="20"></button>
                                </form>
                            </td>
                        </tr>
