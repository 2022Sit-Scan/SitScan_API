...
<div>
    ...
    <div>
        ...
        <form method="POST" action="{{ url('cartas') }}">
            ...
            <a href="{{ route('cartas.index') }}" class="btn btn-link link-atras"><img id="img_cerrarSesion" src="../../imagenes/imagenes/flecha.png" alt="Botón Flecha" height="15" width="30">Regresar
