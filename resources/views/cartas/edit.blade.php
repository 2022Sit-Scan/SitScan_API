...
@section('content')
    ...
    <form method="POST" action="{{ url("cartas/{$carta->id}") }}">
        ...
        <div class="form-group">
            ...
            <a href="{{ route('cartas.index') }}" class="btn btn-link link-atras"><img id="img_cerrarSesion"
                    src="{{asset ('imagenes/imagenes/flecha.png')}}" alt="Botón Flecha" height="15" width="30">Regresar al listado
                de cartas</a>
    </form>
@endsection
