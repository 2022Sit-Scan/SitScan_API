...
@section('content')
    ...
    <div class="row no-gutters">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" id="btn-cancelar-cerrarSesion-cartas"
                                class="btn btn-primary-logout col-md-6" data-dismiss="modal">CANCELAR</button>

                            <button type="button" id="btn-aceptar-cerrarSesion-cartas"
        ...
        <div class="col-6 col-md-6 col-lg-2">
            <p class="btn-end">
                <a href="{{ route('cartas.create') }}" class="btn btn-primary" id="addProducto"> <img
                        src="{{ asset('/imagenes/imagenes/icon_add.png') }}" alt="Editar" height="15" width="15"> NUEVA
                    CARTA </a>
            </p>
        </div>
    </div>
            ...
            <tbody>
                ...
                @foreach ($cartas as $carta)
                    <tr class="fila-tabla">
                        ...
                        <td>
                            <a href="{{ route('cartas.edit', $carta) }}" class="btn btn-link"><img
                                    src="{{ asset('/imagenes/imagenes/icon_edit.svg') }}" alt="Editar" height="25"
                                    width="25"></a>
                            <form action="{{ route('cartas.destroy', $carta) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-link"><img
                                        src="{{ asset('/imagenes/imagenes/icon_delete.svg') }}" alt="Editar" height="20"
                                        width="20"></button>
                            </form>
                        </td>
                    </tr>
