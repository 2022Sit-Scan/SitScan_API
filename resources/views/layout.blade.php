...
<head>
    ...
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/open-iconic/1.1.0/font/css/open-iconic-bootstrap.css"
...
<body>
    ...
    <footer class="footer">
        <div class="container">
            <img src="{{ asset('/imagenes/imagenes/logo_entero_blanco_1.svg') }}" class="logo-blanco" alt="Logo" />
            <span class="text-muted">Si tiene algún tipo de problema técnico, no dude en llamar al <strong>955 85 74
                    92</strong> le atenderemos enseguida</span>
        </div>
    </footer>
