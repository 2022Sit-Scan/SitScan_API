...
@section('content')
    ...
    <form method="POST" action="{{ url("alergenos/{$alergeno->id}") }}">
        ...
        <div class="form-group">
            ...
            <a href="{{ route('alergenos.index') }}" class="btn btn-link link-atras"><img id="img_cerrarSesion"
                    src="{{ asset('/imagenes/imagenes/flecha.png') }}" alt="Botón Flecha" height="15" width="30">Regresar al
