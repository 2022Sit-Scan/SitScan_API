...
<div class="row no-gutters">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" id="btn-cancelar-cerrarSesion-establecimientos" class="btn btn-primary-logout col-md-6" data-dismiss="modal">CANCELAR</button>

            <button type="button" id="btn-aceptar-cerrarSesion-establecimientos" class="btn btn-primary-logout col-md-6">
  ...
  <div class="col-6 col-md-6 col-lg-3">
    <p class="btn-end">
      <a href="{{ route('mesas.create') }}" class="btn btn-primary" id="addProducto"> <img src="./imagenes/imagenes/icon_add.png" alt="Boton Crear Establecimiento" height="15" width="15">NUEVA MESA</a>
    </p>
  </div>
</div>
            ...
            <table class="table">
                <thead class="thead">
                    <tr>
                        ...
                        <th scope="col"><a id="enlace-qr" href="https://www.codigos-qr.com/generador-de-codigos-qr/">Crear códigos QR</a> <br>CÓDIGO QR</th>
