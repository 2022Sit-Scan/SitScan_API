...
<div class="row no-gutters">
    ...
    <div class="col-6 col-md-6 col-lg-2">
        <p class="btn-end">
            <a href="{{ route('mesas.create') }}" class="btn btn-primary" id="addProducto"> <img src="{{ asset('/imagenes/imagenes/icon_add.png') }}" alt="Boton Crear Categoría" height="15" width="15">NUEVA
                MESA </a>
        </p>
    </div>
</div>
...
<table class="table">
    <thead class="thead">
        <tr>
            ...
            <th scope="col">CÓDIGO QR<br><a id="link-qr" href="https://www.codigos-qr.com/generador-de-codigos-qr/">Crear código
                    QR</a></th>
        ...
        <tr class="fila-tabla">
            ...
            <td>
                <form action="{{ route('mesas.destroy', $mesa) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-link"><img src="{{ asset('/imagenes/imagenes/icon_delete.svg') }}" alt="Botón Eliminar" height="26" width="26"></button>
                </form>
            </td>
        </tr>
        @endforeach
