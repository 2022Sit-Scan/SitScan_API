    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" id="btn-cancelar-cerrarSesion-mesas" class="btn btn-primary-logout col-md-6" data-dismiss="modal">CANCELAR</button>

          <button type="button" id="btn-aceptar-cerrarSesion-mesas" class="btn btn-primary-logout col-md-6">
    ...
    <table class="table">
        ...
        <tr class="fila-tabla">
            ...
            <td>
                ...
                <a href="{{ route('mesas.edit', $mesa) }}" class="btn btn-link"><img src="imagenes/imagenes/icon_edit.svg" alt="Editar" height="26" width="26"></span></a>
                <form action="{{ route('mesas.destroy', $mesa) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button  type="submit" class="btn btn-link"><img src="imagenes/imagenes/icon_delete.svg" alt="Botón Eiminar" height="26" width="26"></button>
                </form>                
            </td>
        </tr>
        @endforeach
