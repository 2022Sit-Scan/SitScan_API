                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" id="btn-cancelar-cerrarSesion-productos"
                                class="btn btn-primary-logout col-md-6" data-dismiss="modal">CANCELAR</button>

                            <button type="button" id="btn-aceptar-cerrarSesion-productos"
        ...
        <div class="col-6 col-md-6 col-lg-2">
            <p>
                <a href="{{ route('productos.create') }}" class="btn btn-primary" id="addProducto"><img
                        src="./imagenes/imagenes/icon_add.png" alt="Botón Crear Producto" height="15" width="15">NUEVO
                    PRODUCTO</a>
            </p>
        </div>
    </div>
