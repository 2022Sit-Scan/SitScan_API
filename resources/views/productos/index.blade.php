    ...
    <div class="row no-gutters">
        ...
        <div class="col-6 col-md-6 col-lg-2">
            <a href="#ventana1" id="cerrarSesion" class="btn btn-primary" data-toggle="modal"><img id="img_cerrarSesion"
                    src="{{ asset('/imagenes/imagenes/icon_cerrarSesion.png') }}" alt="Botón Cerrar Sesión" height="12" width="15">CERRAR
                SESION</a>
        ...
        <div class="col-6 col-md-6 col-lg-2">
            <p>
                <a href="{{ route('productos.create') }}" class="btn btn-primary" id="addProducto"><img
                         src="{{ asset('/imagenes/imagenes/icon_add.png') }}" alt="Botón Crear Producto" height="15" width="15">NUEVO
                    PRODUCTO</a>
            </p>
        </div>
                ...
                <tr class="fila-tabla">
                    ...
                    <td>
                        <a href="{{ route('productos.edit', $producto) }}" class="btn btn-link"><img
                                 src="{{ asset('/imagenes/imagenes/icon_edit.svg') }}" alt="Editar" height="30" width="30"></a>
                        <form action="{{ route('productos.destroy', $producto) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-link"><img  src="{{ asset('/imagenes/imagenes/icon_delete.svg') }}"
